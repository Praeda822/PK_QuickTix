...
// - This FormData, along with the current `state` (prevState), is sent to the server.
...
const NewTicketForm = () => {
  ...
  // if any value in the dependency array changes, in this case either the success boolean tied to the state or the router for the navigation, ONLY THEN will the function run again and check if the state's success boolean has changed, consequently redirecting the user
  useEffect(() => {
    if (state.success) {
